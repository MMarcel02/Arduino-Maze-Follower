...
const unsigned int TURN_START_REVERSE_DURATION = 75; // To counter the momentum that could send us over the line if we started turning as soon as we found a line
...
const unsigned int STOP_TIME_AT_INTERSECTION = 500;
